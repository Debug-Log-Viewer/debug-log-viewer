                    ...
                    <div class="settings">
                        ...
                        <div class="row log-viewer-row">
                            ...
                            <div class="log-info-block">
                                ...
                                <input id="dbg_lv_toggle_debug_scripts" type="checkbox" <?php checked(SCRIPT_DEBUG, true); ?> name="checkbox" class="bootstrap-switch" />
                            </div>

                            <div class="log-info-block">
                                <p><?php esc_html_e('Log in file', 'debug-log-viewer'); ?></p>
                                <p class="disabled"></p>
                                <input id="dbg_lv_toggle_debug_log_scripts" type="checkbox" <?php checked(WP_DEBUG_LOG, true); ?> name="checkbox" class="bootstrap-switch" />
                            </div>

                            <div class="log-info-block">
                                <p><?php esc_html_e('Display errors', 'debug-log-viewer'); ?></p>
                                <input id="dbg_lv_toggle_display_errors" type="checkbox" <?php checked(WP_DEBUG_DISPLAY, true); ?> name="checkbox" class="bootstrap-switch" />
                            </div>
                        </div>
                    </div>
