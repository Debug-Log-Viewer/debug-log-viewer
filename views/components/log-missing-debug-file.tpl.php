...
<div class="log-not-found">
  ...
  <div class="row">
    <div class="col-md-12">
      <button id="dlv_log_viewer_enable_logging" class="btn btn-lg btn-info">
        Start Debugging
      </button>
    </div>
    <div class="col-md-12">
    ...
    <div class="col-md-12">
      <a class="manual-debugging-instructions" data-bs-toggle="collapse" href="#dlv_debugging_instructions">
        Manual Debugging Instructions
      </a>
    </div>
  </div>
  <div class="row">
    <div class="collapse" id="dlv_debugging_instructions">
